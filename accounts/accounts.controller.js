...
// //         .then(({ jwtToken, refreshToken, ...account }) => {
// //             setTokenCookie(res, refreshToken);
// //                         // res.json({ user: account, token: jwtToken });  // ✅ wrap in `user`
...
//     // ❗ Reject abusive profile content during registration
// if (containsObjectionableContent(req.body.firstName)) {
//     return res.status(400).json({ message: "First name contains inappropriate content." });
// }
// if (containsObjectionableContent(req.body.lastName)) {
//     return res.status(400).json({ message: "Last name contains inappropriate content." });
// }
// if (req.body.bio && containsObjectionableContent(req.body.bio)) {
//     return res.status(400).json({ message: "Bio contains inappropriate content." });
// }
// if (req.body.nickname && containsObjectionableContent(req.body.nickname)) {
//     return res.status(400).json({ message: "Nickname contains inappropriate content." });
// }
// if (req.body.interests) {
//     const interestList = Array.isArray(req.body.interests)
//         ? req.body.interests
...
//         if (containsObjectionableContent(item)) {
//             return res.status(400).json({ message: "Interests contain inappropriate content." });
//         }
//     }
// }
...
//             return res.json(account);  // return raw object, not wrapped
//         })
//         .catch(next);
// }
...
//     // ❗ Filter inappropriate profile edits
// if (req.body.bio && containsObjectionableContent(req.body.bio)) {
//     return res.status(400).json({ message: "Bio contains inappropriate content." });
// }
// if (req.body.nickname && containsObjectionableContent(req.body.nickname)) {
//     return res.status(400).json({ message: "Nickname contains inappropriate content." });
// }
// if (req.body.funFact && containsObjectionableContent(req.body.funFact)) {
//     return res.status(400).json({ message: "Fun fact contains inappropriate content." });
// }
